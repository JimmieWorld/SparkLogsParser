...
class TestEventAttributesExtractors extends AnyFlatSpec with Matchers with BeforeAndAfterEach {
    ...
    def extract(lines: Seq[String]): (String, Seq[String]) = {
        ...
        SearchResultExtractor.extractSearchResult(bufferedIt, errorStatsAcc)
    }
